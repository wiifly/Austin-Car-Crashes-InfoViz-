    ...
    legend.onAdd = function () {
      ...
      div.innerHTML = `
        <style>
          ...
          .legend-circle { display: inline-block; width: 10px; height: 10px; background: red; border-radius: 50%; margin-right: 5px; }
        </style>
        <div class="legend">
          ...
          <div><span class="legend-circle"></span>High-frequency location</div>
        </div>
      `;
      return div;
    };
